...
For this case, I had to use other friend's result because somehow my code was not converging, even though I seemed to have similar code to my friend's. You can again see that USA suffers from the world tax. Rest of the world also suffers from the worldwide tax.
